...
export default {
  data: function() {
    ...
    methods: {
        ...
        reload: function() {
          axios.get('https://astro-bs-default-rtdb.firebaseio.com/board.json')
        ...
        save: function() {
          if (this.showDialog == "등록")
            axios.post('https://astro-bs-default-rtdb.firebaseio.com/board.json', this.todo)
                 .then(response => {
                   this.reload()
                   return response
                   });               
          else
            axios.put('https://astro-bs-default-rtdb.firebaseio.com/board/' + this.selectedKey + '.json', this.todo)
                 .then(response => {
                   this.reload()
                   return response
                   });
        ...
        remove: function() {
          ...
          axios.delete('https://astro-bs-default-rtdb.firebaseio.com/board/' + this.selectedKey + '.json')
                 .then(response => {
                   this.reload()
                   return response
                   });
